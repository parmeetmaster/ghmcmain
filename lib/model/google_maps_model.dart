...
//
//     final googleMapsModel = googleMapsModelFromJson(jsonString);
...
class GoogleMapsModel {
  ...
  factory GoogleMapsModel.fromRawJson(String str) =>
      GoogleMapsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GoogleMapsModel.fromJson(Map<String, dynamic> json) =>
      GoogleMapsModel(
